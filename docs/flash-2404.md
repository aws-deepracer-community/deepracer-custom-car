...
```
https://aws-deepracer-community-sw.s3.eu-west-1.amazonaws.com/custom-image/ubuntu-24.04/factory_reset_2404.5.zip
```
...
sudo ./usb-build.ubuntu.sh -d <drive> \
  -r https://aws-deepracer-community-sw.s3.eu-west-1.amazonaws.com/custom-image/ubuntu-24.04/factory_reset_2404.5.zip
```
...
start powershell {
    .\usb-build.ps1 -DiskId <disk number> -CreatePartition `
        -CustomResetUrl https://aws-deepracer-community-sw.s3.eu-west-1.amazonaws.com/custom-image/ubuntu-24.04/factory_reset_2404.5.zip
}
```
